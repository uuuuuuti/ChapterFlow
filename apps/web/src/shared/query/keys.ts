...
export const queryKeys = {
  ...
  documents: (id: string | null) => ["project", id, "studio", "documents"] as const,
  document: (id: string | null, documentId: string | null) => ["project", id, "studio", "document", documentId] as const,
